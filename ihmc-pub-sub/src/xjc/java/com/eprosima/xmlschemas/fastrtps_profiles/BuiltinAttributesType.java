 ...
 *       &lt;all>
 *         &lt;element name="discovery_config" type="{http://www.eprosima.com/XMLSchemas/fastRTPS_Profiles}discoverySettingsType" minOccurs="0"/>
 *         &lt;element name="avoid_builtin_multicast" type="{http://www.eprosima.com/XMLSchemas/fastRTPS_Profiles}boolean" minOccurs="0"/>
 *         &lt;element name="use_WriterLivelinessProtocol" type="{http://www.eprosima.com/XMLSchemas/fastRTPS_Profiles}boolean" minOccurs="0"/>
 *         &lt;element name="metatraffic_external_unicast_locators" type="{http://www.eprosima.com/XMLSchemas/fastRTPS_Profiles}externalLocatorListType" minOccurs="0"/>
 ...
 *         &lt;element name="initialPeersList" type="{http://www.eprosima.com/XMLSchemas/fastRTPS_Profiles}locatorListType" minOccurs="0"/>
 *         &lt;element name="readerHistoryMemoryPolicy" type="{http://www.eprosima.com/XMLSchemas/fastRTPS_Profiles}historyMemoryPolicyType" minOccurs="0"/>
 *         &lt;element name="writerHistoryMemoryPolicy" type="{http://www.eprosima.com/XMLSchemas/fastRTPS_Profiles}historyMemoryPolicyType" minOccurs="0"/>
 *         &lt;element name="readerPayloadSize" type="{http://www.eprosima.com/XMLSchemas/fastRTPS_Profiles}uint32" minOccurs="0"/>
 *         &lt;element name="writerPayloadSize" type="{http://www.eprosima.com/XMLSchemas/fastRTPS_Profiles}uint32" minOccurs="0"/>
 *         &lt;element name="mutation_tries" type="{http://www.eprosima.com/XMLSchemas/fastRTPS_Profiles}uint32" minOccurs="0"/>
 *         &lt;element name="typelookup_config" type="{http://www.eprosima.com/XMLSchemas/fastRTPS_Profiles}typelookupSettingsType" minOccurs="0"/>
 *       &lt;/all>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class BuiltinAttributesType {
    ...
    @XmlElement(name = "typelookup_config")
    protected TypelookupSettingsType typelookupConfig;
    ...
    /**
     * Gets the value of the typelookupConfig property.
     * 
     * @return
     *     possible object is
     *     {@link TypelookupSettingsType }
     *     
     */
    public TypelookupSettingsType getTypelookupConfig() {
        return typelookupConfig;
    }

    /**
     * Sets the value of the typelookupConfig property.
     * 
     * @param value
     *     allowed object is
     *     {@link TypelookupSettingsType }
     *     
     */
    public void setTypelookupConfig(TypelookupSettingsType value) {
        this.typelookupConfig = value;
    }
